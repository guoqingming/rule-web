...
import com.secbro.drools.filter.GunsUserFilter;
import com.secbro.drools.shiro.ShiroDbRealm;
...
//        securityManager.setCacheManager(cacheShiroManager);
     ...
     */
//    @Bean
////    @ConditionalOnProperty(prefix = "guns", userNameCn = "spring-session-open", havingValue = "true")
...
//    }
     ...
     */
    @Bean
//    @ConditionalOnProperty(prefix = "guns", userNameCn = "spring-session-open", havingValue = "false")
    public DefaultWebSessionManager defaultWebSessionManager() {
        DefaultWebSessionManager sessionManager = new DefaultWebSessionManager();
//        sessionManager.setCacheManager(cacheShiroManager);
        sessionManager.setSessionValidationInterval(90 * 1000);
