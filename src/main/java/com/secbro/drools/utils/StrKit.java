...
public class StrKit {
	 ...
	 * 例如：str=setName, preLength=3 -> return userNameCn
	 * 
	 * @param str 被处理的字符串
	...
	/**
	 * 原字符串首字母大写并在其首部添加指定字符串 例如：str=userNameCn, preString=get -> return getName
	 * 
	 * @param str 被处理的字符串
